...
check-server:
	cd services/open-tutti-server && GOMODCACHE=$(GOMODCACHE) GOCACHE=$(GOCACHE) GOPATH=$(GOPATH) GOWORK=$(OT_GOWORK) gofmt -l . && GOMODCACHE=$(GOMODCACHE) GOCACHE=$(GOCACHE) GOPATH=$(GOPATH) GOWORK=$(OT_GOWORK) go vet ./... && GOMODCACHE=$(GOMODCACHE) GOCACHE=$(GOCACHE) GOPATH=$(GOPATH) GOWORK=$(OT_GOWORK) go test ./...

check-room-sync:
	cd services/open-tutti-room-sync && GOMODCACHE=$(GOMODCACHE) GOCACHE=$(GOCACHE) GOPATH=$(GOPATH) GOWORK=$(OT_GOWORK) gofmt -l . && GOMODCACHE=$(GOMODCACHE) GOCACHE=$(GOCACHE) GOPATH=$(GOPATH) GOWORK=$(OT_GOWORK) go vet ./... && GOMODCACHE=$(GOMODCACHE) GOCACHE=$(GOCACHE) GOPATH=$(GOPATH) GOWORK=$(OT_GOWORK) go test ./...
